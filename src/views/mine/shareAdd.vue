<template>
    <div class="page-limit-width">
        <div class="content-cage">
            <div class="ps-r">
                <textarea class="msa-textarea-box of-no-sb" rows="4" placeholder="说点什么吧~" :maxlength="MAX_TEXT_LENGTH" @input="onTextAreaInput" />
                <span class="msa-input-remaining">{{inputRemainingLength}}</span>
            </div>
            <div class="mg-t-1rem mg-b-rem5 bd-t-f0"><!-- 分隔线 --></div>
            ...
            <div class="mg-tb-rem5 bd-t-f0"><!-- 分隔线 --></div>
            <div class="fx-hc lh-1x pd-tb-rem5 tp-f0 us-n">
